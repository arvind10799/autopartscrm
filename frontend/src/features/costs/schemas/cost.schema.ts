...
export const shipmentCostSchema = shipmentCostBackendSchema.transform((cost) => ({
  ...
  estimatedPurchaseAmount: cost.estimatedPurchaseAmount,
  estimatedShippingCharges: cost.estimatedShippingAmount,
  hasActualPurchaseAmount: cost.hasActualPurchaseAmount,
  hasActualShippingAmount: cost.hasActualShippingAmount,
...
export const shipmentCostFormSchema = z
  .object({
    ...
    estimatedPurchaseAmount: amountInputSchema.optional(),
    estimatedShippingCharges: amountInputSchema.optional(),
