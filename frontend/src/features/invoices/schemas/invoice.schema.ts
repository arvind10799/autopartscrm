...
export const invoiceRecordSchema = z.object({
  ...
  customerSignatureImage: z.string().nullable().optional().default(null),
  ...
  hasAuditTrail: z.boolean().optional().default(false),
  hasPhotoIdDocument: z.boolean().optional().default(false),
  createdAt: z.string(),
  updatedAt: z.string(),
});
